document.getElementById('inputfile').addEventListener('change', function() {
  ...
  fileReader.onload=function(){
      ...
      second_largest_number = summed_up_list.sort((a,b) => a-b).reverse()[1];
      third_largest_number = summed_up_list.sort((a,b) => a-b).reverse()[2];

      console.log(largest_number + second_largest_number + third_largest_number);
  }
